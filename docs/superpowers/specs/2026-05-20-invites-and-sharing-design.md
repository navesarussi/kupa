...
GET /g/B8YcK3M2
  ...
  └─ Return HTML with:
       ...
       • JS that attempts `com.kupa.mobile://invite/g/<token>` as fallback
...
- `com.kupa.mobile://invite/i/<token>` → `friend` (custom-scheme fallback)
- `com.kupa.mobile://invite/g/<token>` → `group`
